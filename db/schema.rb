...
ActiveRecord::Schema.define(version: 20140321012755) do
  ...
  add_index "holidays", ["business_id"], name: "index_holidays_on_business_id"
  ...
  add_index "votes", ["business_id"], name: "index_votes_on_business_id"
